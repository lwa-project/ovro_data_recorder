...
ExtensionModules = [Extension('_gridder', ['gridder.cpp',], include_dirs=[numpy.get_include()], libraries=['m', 'fftw3f'], extra_compile_args=['-DNPY_NO_DEPRECATED_API=NPY_1_7_API_VERSION',]),]
